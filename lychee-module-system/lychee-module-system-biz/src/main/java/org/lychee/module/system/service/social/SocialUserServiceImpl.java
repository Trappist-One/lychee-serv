...
public class SocialUserServiceImpl implements SocialUserService {
    ...
    @Resource// 由于自定义了 LycheeAuthRequestFactory 无法覆盖默认的 AuthRequestFactory，所以只能注入它
    private LycheeAuthRequestFactory lycheeAuthRequestFactory;
    ...
    public String getAuthorizeUrl(Integer type, String redirectUri) {
        ...
        AuthRequest authRequest = lycheeAuthRequestFactory.get(SocialTypeEnum.valueOfType(type).getSource());
        // 生成跳转地址
