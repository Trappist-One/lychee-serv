package org.lychee.module.system.service.user;

import cn.hutool.core.util.RandomUtil;
import org.lychee.framework.common.enums.CommonStatusEnum;
import org.lychee.framework.common.exception.ServiceException;
import org.lychee.framework.common.pojo.PageResult;
import org.lychee.framework.common.util.collection.ArrayUtils;
...
import org.lychee.module.system.controller.admin.user.vo.profile.UserProfileUpdatePasswordReqVO;
import org.lychee.module.system.controller.admin.user.vo.profile.UserProfileUpdateReqVO;
import org.lychee.module.system.controller.admin.user.vo.user.*;
import org.lychee.module.system.dal.dataobject.dept.DeptDO;
import org.lychee.module.system.dal.dataobject.dept.PostDO;
import org.lychee.module.system.dal.dataobject.dept.UserPostDO;
...
import org.lychee.module.system.dal.mysql.dept.UserPostMapper;
import org.lychee.module.system.dal.mysql.user.AdminUserMapper;
import org.lychee.module.system.enums.common.SexEnum;
...
import org.lychee.module.system.service.tenant.TenantService;
...
public class AdminUserServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreatUser_success() {
        ...
        when(passwordEncoder.encode(eq(reqVO.getPassword()))).thenReturn("lycheeyuanma");
        ...
        assertEquals("lycheeyuanma", user.getPassword());
    ...
    public void testImportUserList_02() {
        ...
        when(deptService.getDept(eq(dept.getId()))).thenReturn(dept);
        // mock passwordEncoder 的方法
        when(passwordEncoder.encode(eq("lycheeyuanma"))).thenReturn("java");
