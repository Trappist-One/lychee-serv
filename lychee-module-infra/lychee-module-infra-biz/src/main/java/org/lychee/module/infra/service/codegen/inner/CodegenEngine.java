package org.lychee.module.infra.service.codegen.inner;
...
import org.lychee.framework.excel.core.annotations.DictFormat;
import org.lychee.framework.excel.core.convert.DictConvert;
import org.lychee.framework.excel.core.util.ExcelUtils;
import org.lychee.framework.mybatis.core.dataobject.BaseDO;
...
import org.lychee.framework.operatelog.core.enums.OperateTypeEnum;
...
import org.lychee.module.infra.enums.codegen.CodegenFrontTypeEnum;
...
public class CodegenEngine {
    ...
    private static String javaModuleFilePath(String path, String module, String src) {
        return "lychee-module-${table.moduleName}/" + // 顶级模块
                "lychee-module-${table.moduleName}-" + module + "/" + // 子模块
                "src/" + src + "/java/${basePackage}/module/${table.moduleName}/" + path + ".java";
    }

    private static String mapperXmlFilePath() {
        return "lychee-module-${table.moduleName}/" + // 顶级模块
                "lychee-module-${table.moduleName}-biz/" + // 子模块
    ...
    private static String vueFilePath(String path) {
        return "lychee-ui-${sceneEnum.basePackage}/" + // 顶级目录
                "src/" + path;
    }
    ...
    private static String vue3FilePath(String path) {
        return "lychee-ui-${sceneEnum.basePackage}-vue3/" + // 顶级目录
                "src/" + path;
    }
