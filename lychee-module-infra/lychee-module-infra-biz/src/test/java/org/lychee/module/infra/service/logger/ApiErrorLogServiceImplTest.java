...
import org.lychee.module.infra.dal.mysql.logger.ApiErrorLogMapper;
import org.lychee.module.infra.enums.logger.ApiErrorLogProcessStatusEnum;
...
import static org.lychee.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_NOT_FOUND;
import static org.lychee.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_PROCESSED;
...
public class ApiErrorLogServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetApiErrorLogPage() {
        ...
        ApiErrorLogDO apiErrorLogDO = randomPojo(ApiErrorLogDO.class, o -> {
            ...
            o.setApplicationName("lychee-test");
            o.setRequestUrl("foo");
        ...
        reqVO.setApplicationName("lychee-test");
