package org.lychee.module.bpm.controller.admin.definition.vo.model;
...
public class BpmModelBaseVO {
    ...
    @Schema(description = "流程标识", requiredMode = Schema.RequiredMode.REQUIRED, example = "process_lychee")
