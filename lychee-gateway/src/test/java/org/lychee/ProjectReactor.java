...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "org.lychee";
    private static final String ARTIFACT_ID = "lychee";
    private static final String PACKAGE_NAME = "org.lychee";
    private static final String TITLE = "荔枝管理系统";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "org.lychee";
        String artifactIdNew = "lychee";
        String packageNameNew = "org.lychee";
        String titleNew = "荔枝管理系统";
        String projectBaseDirNew = "lychee-serv"; // 一键改名后，“新”项目所在的目录
