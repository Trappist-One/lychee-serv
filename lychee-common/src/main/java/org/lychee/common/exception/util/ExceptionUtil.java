package org.lychee.common.exception.util;
 ...
 * <p>
 * 1. 异常提示信息，写在枚举类中，例如说，{@link ErrorCodeEnum} 类 + ExceptionUtilConfiguration
...
public class ExceptionUtil {
    ...
    public static void putAll(Map<Integer, String> messages) {
        ExceptionUtil.MESSAGES.putAll(messages);
    }

    public static void put(Integer code, String message) {
        ExceptionUtil.MESSAGES.put(code, message);
    }

    public static void delete(Integer code, String message) {
        ExceptionUtil.MESSAGES.remove(code, message);
    }
    ...
    /**
     * 创建指定编号的 ExceptionUtil 的异常
     *
     * @param code 编号
     * @return 异常
     */
    public static ServerException exception(Integer code) {
     ...
     * @return 异常
     */
    public static ServerException exception(Integer code, Object... params) {
        return exception0(code, MESSAGES.get(code), params);
    }

    public static ServerException exception0(Integer code, String messagePattern, Object... params) {
