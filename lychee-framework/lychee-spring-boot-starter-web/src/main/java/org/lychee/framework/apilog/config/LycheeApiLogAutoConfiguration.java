...
import org.lychee.module.infra.api.logger.ApiAccessLogApi;
...
@AutoConfiguration(after = LycheeWebAutoConfiguration.class)
public class LycheeApiLogAutoConfiguration {
     ...
     */
    @Bean
    @ConditionalOnProperty(prefix = "lychee.access-log", value = "enable", matchIfMissing = true) // 允许使用 lychee.access-log.enable=false 禁用访问日志
