package org.lychee.framework.desensitize.core;

import org.lychee.framework.common.util.json.JsonUtils;
import org.lychee.framework.desensitize.core.regex.annotation.EmailDesensitize;
import org.lychee.framework.desensitize.core.regex.annotation.RegexDesensitize;
import org.lychee.framework.desensitize.core.annotation.Address;
import org.lychee.framework.desensitize.core.slider.annotation.BankCardDesensitize;
import org.lychee.framework.desensitize.core.slider.annotation.CarLicenseDesensitize;
import org.lychee.framework.desensitize.core.slider.annotation.ChineseNameDesensitize;
import org.lychee.framework.desensitize.core.slider.annotation.FixedPhoneDesensitize;
import org.lychee.framework.desensitize.core.slider.annotation.IdCardDesensitize;
import org.lychee.framework.desensitize.core.slider.annotation.PasswordDesensitize;
import org.lychee.framework.desensitize.core.slider.annotation.MobileDesensitize;
import org.lychee.framework.desensitize.core.slider.annotation.SliderDesensitize;
