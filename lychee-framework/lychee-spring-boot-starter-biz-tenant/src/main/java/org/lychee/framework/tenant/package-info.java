 ...
 *      1）Spring Async：
 *          {@link org.lychee.framework.quartz.config.LycheeAsyncAutoConfiguration#threadPoolTaskExecutorBeanPostProcessor()}
 *      2）Spring Security：
 *          TransmittableThreadLocalSecurityContextHolderStrategy
 *          和 LycheeSecurityAutoConfiguration#securityContextHolderMethodInvokingFactoryBean() 方法
 *
 */
package org.lychee.framework.tenant;
