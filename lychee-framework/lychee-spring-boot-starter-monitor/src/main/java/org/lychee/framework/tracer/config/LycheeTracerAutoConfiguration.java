package org.lychee.framework.tracer.config;

import org.lychee.framework.common.enums.WebFilterOrderEnum;
import org.lychee.framework.tracer.core.aop.BizTraceAspect;
import org.lychee.framework.tracer.core.filter.TraceFilter;
...
@ConditionalOnProperty(prefix = "lychee.tracer", value = "enable", matchIfMissing = true)
public class LycheeTracerAutoConfiguration {
